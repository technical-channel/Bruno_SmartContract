...
// Constructor of Solidity
    constructor(address _icoTokenAddr, address _busdContractAddress, uint256 _startTime, uint256 _endTime) {  
 ...
 // buyToken function that will use to sell the SoldOut Token
  ...
  // It will mark entry in client SellTrack (it should be private)
    ...
    function getTokenomics() public view returns(uint8, uint8, uint256, uint256, uint256, uint256, uint256, uint256,uint256,uint256){
        return(icoTokenDecimals, busdTokenDecimals, presaleRate, startTime, endTime, totalTokenNeedForInvestor, TotalCollectedBNBFund, totalTokenSupply,softCap,hardCap);
    }
